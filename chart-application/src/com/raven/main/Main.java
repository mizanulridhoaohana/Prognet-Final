...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        title.setBackground(new Color(210, 218, 255));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Office Talk");

        cmdMaximize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/maximize.png"))); // NOI18N
        ...
        cmdMaximize.setMaximumSize(new java.awt.Dimension(19, 19));
        cmdMaximize.setMinimumSize(new java.awt.Dimension(19, 19));
        cmdMaximize.setPreferredSize(new java.awt.Dimension(19, 19));
        ...
        titleLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, titleLayout.createSequentialGroup()
                ...
                .addComponent(cmdMaximize, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
        ...
        titleLayout.setVerticalGroup(
            ...
            .addGroup(titleLayout.createSequentialGroup()
                ...
                .addGroup(titleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmdClose, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
        ...
        backgroundLayout.setVerticalGroup(
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, 607, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void cmdMaximizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdMaximizeActionPerformed
        ...
        if (getExtendedState() == JFrame.MAXIMIZED_BOTH) {
            ...
            updateLogo("maximized");
        }
    }//GEN-LAST:event_cmdMaximizeActionPerformed
    
    private void updateLogo(String state) {
        String imagePath;
        if ("maximized".equals(state)) {
            imagePath = "/com/raven/icon/maximize_mini.png"; // Path to your maximized logo
        } else {
            imagePath = "/com/raven/icon/maximize.png"; // Path to your normal logo
        }

        ImageIcon icon = new ImageIcon(getClass().getResource(imagePath));
        cmdMaximize.setIcon(icon); // Assuming jButton1 is the button with the logo
    }
