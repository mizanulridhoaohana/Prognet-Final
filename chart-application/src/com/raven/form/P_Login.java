...
public class P_Login extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbTitle.setForeground(new java.awt.Color(22, 79, 218));
        lbTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbTitle.setText("Login");

        jLabel1.setText("User Name");

        txtUser.setCaretColor(new java.awt.Color(210, 218, 255));
        txtUser.setDisabledTextColor(new java.awt.Color(210, 218, 255));

        jLabel2.setText("Password");

        cmdLogin.setBackground(new java.awt.Color(22, 79, 218));
        ...
        cmdRegister.setFont(new java.awt.Font("sansserif", 1, 11)); // NOI18N
        cmdRegister.setForeground(new java.awt.Color(165, 181, 255));
