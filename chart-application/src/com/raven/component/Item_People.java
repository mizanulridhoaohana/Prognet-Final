...
public class Item_People extends javax.swing.JPanel {
    ...
    private static Item_People selectedProfile;

    private void init() {
        addMouseListener(new MouseAdapter() {
        @Override
        public void mouseEntered(MouseEvent me) {
            if (selectedProfile != Item_People.this) {
        ...
        public void mouseReleased(MouseEvent me) {
            if (mouseOver) {
                if (selectedProfile != null) {
                    selectedProfile.setBackground(new Color(255, 255, 255));
                }
                selectedProfile = Item_People.this;
    ...
    private void initComponents() {
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/user.png")));
