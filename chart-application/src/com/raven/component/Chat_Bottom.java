...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        txt.setHintText("Write your big idea ...");
        ...
        cmd.setVerticalTextPosition(SwingConstants.CENTER);
        cmd.setHorizontalTextPosition(SwingConstants.CENTER);
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(123, 102, 255));
